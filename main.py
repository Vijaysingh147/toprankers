...
@bot.on_message(filters.command(["start"]) & ~filters.edited_message)
...
#testing topranker
# @bot.on_message(filters.command(["top"])& ~filters.edited_message)
...
@bot.on_message(filters.command(["link"])& ~filters.edited_message)
async def upload(bot: Client, m: Message):
...
@bot.on_message(filters.command(["aio"])& ~filters.edited_message)
...
@bot.on_message(filters.command(["ytdlp"])& ~filters.edited_message)
async def account_login(bot: Client, m: Message):
...
@bot.on_message(filters.command(["pyro"])& ~filters.edited_message)
async def account_login(bot: Client, m: Message):
